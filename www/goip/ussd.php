...
for(;;){
        ...
        elseif($err==0){ //全体超时                                                                               
                if(--$timer <= 0){                                                                                
                        if($debug) echo "<script language=\"javascript\">alert('超时! Goip 没有响应')</script>";  
...
<table wIdth="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td height="30"><a href="goip.php" target=main>参数管理</a>&nbsp;|&nbsp;<a href="goip.php?action=add" target=main>添加机器</a>&nbsp;|&nbsp;<a href="ussdinfo.php" target=main>USSD发送记录</a></td>
  </tr>
</table>
...
<form method="post" action="ussd.php?debug=1&TERMID=<?php echo $_REQUEST[TERMID] ?>" name="form1">
  ...
  <table wIdth="600" border="0" align="center" cellpadding="1" cellspacing="1" class="border" >
    ...
    <tr>
	<td wIdth="180" align="right" class="tdbg"><strong>USSD返回信息:</strong></td>
      <td height="22"  class="tdbg"><?php echo $ussdmsg ?></td>
    </tr>
    <tr> 
      <td wIdth="180" align="right" class="tdbg"><strong>USSD命令:</strong></td>
      <td class="tdbg"><input type="input" id="USSDMSG" name="USSDMSG" >  &nbsp;&nbsp;&nbsp;&nbsp;  <a href="ussd.php?TERMID=<?php echo $_REQUEST[TERMID]?>&debug=1&USSDMSG=1&action=exit" target=main onclick="return confirm('确认要断开ussd?');">立即断开</a></td>
    </tr>
    <tr>                                                                                                          
