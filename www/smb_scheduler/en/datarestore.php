...
if(!$_POST['act']&&$_SESSION['data_file'])
{
	...
	if(import($filename)) $msgs[]="Backup File".$_SESSION['data_file']."Import Database Successfully";
	else {$msgs[]="备份文件".$_SESSION['data_file']."Import failure";show_msg($msgs);pageend();}
