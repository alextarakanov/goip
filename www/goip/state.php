...
<form method="post" action="state.php?" name="form1" onSubmit="javascript:return check_pw();">
  ...
  <table wIdth="600" border="0" align="center" cellpadding="2" cellspacing="1" class="border" >
    ...
    <tr> 
      <td wIdth="200" align="right" class="tdbg"><strong>附近基站列表:</strong></td>
      <td class="tdbg"><?php echo $goiprow['BCCH'] ?></td>
      <td width="200" class="tdbg"><input type="input" id="base" name="base" size=1><a href="" onclick="window.location='?id=<?php echo $_GET[id];?>&cmd=set_base_cell&value='+getElementById('base').value;return false;" >设置基站</a></td>
    </tr>
    <tr>
	...
	<a href="state.php?id=<?php echo $_GET[id]?>&cmd=GSM" target=main>刷新</a>
