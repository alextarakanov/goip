...
if(isset($_GET['action'])) {
	...
	if($action=="del")
	{
		...
		if($ErrMsg!="")
			...
			WriteSuccessMsg("<br><li>Delete successful</li>","rm_device.php");
		}
	}
	elseif($action=="add")
	{
	...
	elseif($action=="saveadd")
	{
		...
		if($ErrMsg!="")
			...
			WriteSuccessMsg("<br><li>Add Successful</li>","rm_device.php");				
		}
	}
...
*/		
		...
		if($ErrMsg!="")
			...
			WriteSuccessMsg("<br><li>Modify GoIP Successful</li>","rm_device.php");
		}
	}
	else if($action=="reboot"){
		$send[]=my_pack2(MACHINE_REBOOT, $_GET['name'], TYPE_GOIP);
		sendto_xchanged($send);
		WriteSuccessMsg("<br><li>The commond is sended to GoIP($_GET[name]).</li>","rm_device.php");
	}
