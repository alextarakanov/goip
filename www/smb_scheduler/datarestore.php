...
<table wIdth="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  ...
  <tr class="tdbg" onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#BFDFFF'">
    <td valign="middle"><ul>
        <li>本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定是否需要恢复，以免造成数据损失</li>
        <li>数据恢复功能只能恢复由本系统导出的数据文件，其他软件导出格式可能无法识别</li>
        <li>从本地恢复数据需要服务器支持文件上传并保证数据尺寸小于允许上传的上限，否则只能使用从服务器恢复.目前服务器上传文件大小限制为<?php echo ini_get('file_uploads') ? ini_get('upload_max_filesize') : 'Disabled'; ?>, 如有需要请修改服务器配置.</li>
   	 </ul>
	</td>
  </tr>
</table>
